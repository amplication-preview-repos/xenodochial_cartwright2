...
@InputType()
class PlaidIntegrationCreateNestedManyWithoutUsersInput {
...
export { PlaidIntegrationCreateNestedManyWithoutUsersInput as PlaidIntegrationCreateNestedManyWithoutUsersInput };
